...
SWIFT_MODULE_NAMESPACE_PUSH("Qr_reader")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC9Qr_reader11AppDelegate")
...
SWIFT_CLASS("_TtC9Qr_reader14ViewController")
@interface ViewController : UIViewController <AVCaptureMetadataOutputObjectsDelegate>
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified square;
@property (nonatomic, strong) AVCaptureVideoPreviewLayer * _Nonnull video;
- (void)viewDidLoad;
